...
#   ~/TFM/repositories/real_machine_checkpoint/launch_scripts/run_mixed.sh ...
#
...
DEST="${DEST:-\$HOME/TFM/repositories/real_machine_checkpoint}"
BRANCH="${1:-master}"
...
echo "  ssh $REMOTE"
echo "  \$HOME/TFM/repositories/real_machine_checkpoint/launch_scripts/run_mixed.sh <tag> <insts> timing --pmu <ckpt...>"
